...
double kP = 0.37; // proportional gain constant (tune this value for your robot). Bigger kP = faster gain, Smaller kP= slower gain. If the robot is oscillating around the target distance, try reducing this value. If the robot is not reaching the target distance, try increasing this value.
...
*/
double kD = 0.1; // derivative gain constant (tune this value for your robot). Bigger kD = stronger braking effect. Smaller kD = weaker breaking effect.
...
*/
double kI = 0.09; // integral gain constant (tune this value for your robot).
